...
//	public Long removeAllByUserId(Long id);
	...
	public List<Deal> findAllBySubCategoryCategoryNameAndSubCategoryNameAndCityNameIgnoreCaseLikeOrPlaceNameIgnoreCaseLikeAndUserPlanPlanType(String categoryName, String subCatName, String cityName, String placeName, PlanType planType);
